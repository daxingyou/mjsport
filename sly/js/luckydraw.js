        ...
        $.getJSON(listUrl+"lottery/index",function(json){
            if(json.memberBeanInfo){
                if(json.memberInfo.nickname){
                    $("#mybigname").html(json.memberInfo.nickname);
                }else if (json.memberInfo.name=="魔杰会员"){
                    $("#mybigname").html(json.memberInfo.name);
                }else{
                    $("#mybigname").html(nameExc(json.memberInfo.name));
                }
                $("#memberBeanInfo").html(json.memberBeanInfo.balanceBean);
                //$("#mybigname").html(json.memberInfo.name.replace(/.(?=.)/, '*'));
                ...
                //未登录状态
                $("#memberBeanInfo").html('<a id="login-btn" href="javascript:;">点击登录!</a>')
            ...
            if(json.errMsg == "成功"){
                ...
                data.goodsList.forEach(function(item){
                    giftliststr += giftlist(item ,giftindex);
                    giftindex =giftindex+1;
                })
                $("#luck").html(giftliststr);
                ...
                var luck={
                    ...
                    stop:function(index){
                        ...
                        console.log(data.goodsList[this.prize].name)
                        $(".giftname").html(data.goodsList[this.prize].name)
                        $(".mask").show();
                        $(".shine-star").show();
                        $(".haswin").show()
                        return false;
